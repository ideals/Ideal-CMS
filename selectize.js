            ...
            if (e.type && e.type.toLowerCase() === 'keydown') {
                ...
                if (keyCode === KEY_DELETE || keyCode === KEY_BACKSPACE) {
                    ...
                    if (selection.length) {
                        ...
                        if (keyCode === KEY_BACKSPACE && selection.start) {
    ...
    $.extend(Selectize.prototype, {
        ...
        setActiveItem: function ($item, e) {
            ...
            if (eventName === 'mousedown' && self.isShiftDown && self.$activeItems.length) {
                ...
                if ((eventName === 'mousedown' && self.isCtrlDown) || (eventName === 'keydown' && this.isShiftDown)) {
        ...
        deleteSelection: function (e) {
            ...
            if (self.$activeItems.length) {
                ...
                if ((self.isFocused || self.settings.mode === 'single') && self.items.length) {
                    if (direction < 0 && selection.start === 0 && selection.length === 0) {
                        values.push(self.items[self.caretPos - 1]);
                    } else {
                        if (direction > 0 && selection.start === self.$control_input.val().length) {
