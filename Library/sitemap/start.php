 ...
 * /bin/php /var/www/example.com/super/Ideal/Library/sitemap/start.php
 *
 * 2. Из командной строки из папки скрипта (без буферизации вывода):
 * /bin/php start.php
 *
 * 3. Из браузера:
 * http://example.com/super/Ideal/Library/sitemap/start.php
 *
 ...
 * http://example.com/super/Ideal/Library/sitemap/start.php?w=1
 *
 */
