...
1. FIX: описание установки крона
1. FIX: в кроне выполняется только по одной задаче за один запуск
1. FIX: редирект со страницы с page=1 на страницу без параметра page
